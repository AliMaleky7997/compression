...
_CONFIGS = {
    ...
    'hific_lo_nolpips': helpers.Config(
        model_type=helpers.ModelType.COMPRESSION_GAN,
        lambda_schedule=helpers.Config(
            vals=[2., 1.],
            steps=[50000]),
    ...
    'mselpips_lo_nolpips': helpers.Config(
        model_type=helpers.ModelType.COMPRESSION,
        lambda_schedule=helpers.Config(
            vals=[2., 1.],
            steps=[50000]),
    ...
    'hific_mi_nolpips': helpers.Config(
        model_type=helpers.ModelType.COMPRESSION_GAN,
        lambda_schedule=helpers.Config(
            vals=[2., 1.],
            steps=[50000]),
        ...
        loss_config=helpers.Config(
            ...
            C=0.1 * 2. ** -5,
            CD=0.75,
            target=0.3,  # This is $r_t$ in the paper.
            lpips_weight=0.,
            target_schedule=helpers.Config(
                vals=[0.20/0.14, 1.],  # Factor is independent of target.
                steps=[50000]),
    ...
    'mselpips_mi_nolpips': helpers.Config(
        model_type=helpers.ModelType.COMPRESSION,
        lambda_schedule=helpers.Config(
            vals=[2., 1.],
            steps=[50000]),
    ...
    'hific_hi_nolpips': helpers.Config(
        model_type=helpers.ModelType.COMPRESSION_GAN,
        lambda_schedule=helpers.Config(
            vals=[2., 1.],
            steps=[50000]),
        ...
        loss_config=helpers.Config(
            ...
            C=0.1 * 2. ** -5,
            CD=0.75,
            target=0.45,  # This is $r_t$ in the paper.
            lpips_weight=0.,
            target_schedule=helpers.Config(
                vals=[0.20/0.14, 1.],  # Factor is independent of target.
                steps=[50000]),
    ...
    'mselpips_hi_nolpips': helpers.Config(
        model_type=helpers.ModelType.COMPRESSION,
        lambda_schedule=helpers.Config(
            vals=[2., 1.],
            steps=[50000]),
